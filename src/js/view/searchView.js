...
export const limitRepiceTitle = (title, limit = 17) => {
    const newTitle = [];
...
const renderRecipe = recipe => {
    ...
    <a class="results__link" href="#${recipe.recipe_id}">
        ...
        <div class="results__data">
            <h4 class="results__name">${limitRepiceTitle(recipe.title)}</h4>
...
const createButton = (page, type) =>
    `
    <button class="btn-inline btn-inline results__btn--${type}" data-goto=${type === 'prev' ? page -1 : page +1}>
